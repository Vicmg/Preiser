...
#---------------------------------------------------------------------------------------------------------------
	...
	path('editarD/<int:id_Dprest>/',editar_DetallePrestamo,name='ver_DetallePrestamo'),
...
#-----------------------------------------------------------------------------------------------------------------
	...
	path('editar_aprendiz/<int:id_apr>/',vista_editar_aprendiz,name='vista_editar_aprendiz'),	
		...
		#	urls 
		#	Una URL es una dirección de la web. 
		#	Puedes ver una URL cada vez que visitas una página.
		#	Se ve en la barra de direcciones del navegador ejemplo (127.0.0.1:8000,https://django.org)
		#	El archivo urls.py actúa como puerta de entrada para las peticiones HTTP
		#	Se definen URLs elegantes mediante expresiones regulares que redirigen a las  vistas
		#	basadas en funciones o vistas basadas en clases de views.py
